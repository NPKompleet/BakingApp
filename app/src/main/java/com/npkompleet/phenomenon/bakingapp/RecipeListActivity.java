...
import com.npkompleet.phenomenon.bakingapp.IdlingResource.RecipeIdlingResource;
import com.npkompleet.phenomenon.bakingapp.pojo.Recipe;
import com.npkompleet.phenomenon.bakingapp.utils.NetworkBroadcastReceiver;
...
public class RecipeListActivity extends AppCompatActivity
    ...
    private void getFavoriteRecipe(){
       /* String[] projection= {RecipeContract.COLUMN_RECIPE};
        ...
        SharedPreferences sharedPref = getSharedPreferences(RecipeStepActivity.RECIPE_PREF, Context.MODE_PRIVATE);
        favoriteRecipe = sharedPref.getString(RecipeStepActivity.FAVORITE_RECIPE, "");
